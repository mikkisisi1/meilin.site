...
const translations = {
  ru: {
    welcome: 'Добро пожаловать в SlimLight',
    ...
    missionTitle: 'О SlimLight',
    missionText: 'SlimLight — гибридная платформа психологической помощи, объединяющая ИИ-психолога и живых специалистов.',
    ctaButton: 'Психолог',
    advance: 'Аванс',
  },
  en: {
    welcome: 'Welcome to SlimLight',
    ...
    missionTitle: 'About SlimLight',
    missionText: 'SlimLight is a hybrid mental health platform combining AI psychologist and live specialists.',
    ctaButton: 'Psychologist',
    advance: 'Advance',
  },
  zh: { welcome: '欢迎来到 SlimLight', subtitle: '您的AI心理咨询师 24/7在线', login: '登录', register: '注册', email: '邮箱', password: '密码', name: '姓名', chooseProblems: '什么困扰着您？', chooseVoice: '选择AI心理咨询师的声音', male: '男性', female: '女性', startChat: '开始对话', tariffs: '套餐', tariffPrompt: '选择套餐以继续', minutesLeft: '剩余', min: '分钟', hours: '小时', specialists: '专家', radio: 'SlimLight Radio', profile: '我的资料', about: '关于', contacts: '联系方式', links: '链接', bookPsychologist: '预约心理咨询', language: '语言', theme: '主题', light: '浅色', dark: '深色', system: '跟随系统', logout: '退出', sendMessage: '输入消息...', freeSession: '免费咨询', paidSession: '付费咨询', testFree: '试用：3分钟免费', bookConsultation: '预约咨询', playing: '播放中...', paused: '已暂停', musicDesc: '放松音乐', paymentSuccess: '支付成功！', paymentProcessing: '正在确认支付...', back: '返回', noAccount: '没有账号？', haveAccount: '已有账号？', anxiety: '焦虑与恐慌', depression: '抑郁', relationships: '人际关系', ptsd: '创伤后应激', self_esteem: '自尊心', eating_disorder: '饮食障碍', weight: '体重问题', grief: '丧失与哀伤', meaning: '寻找人生意义', other: '其他', expert: '项目专家', missionTitle: '关于 SlimLight', missionText: 'SlimLight 是一个结合AI心理咨询师和真人专家的心理健康平台。', ctaButton: '心理咨询' },
  es: { welcome: 'Bienvenido a SlimLight', subtitle: 'Tu psicólogo IA disponible 24/7', login: 'Iniciar sesión', register: 'Registrarse', email: 'Correo', password: 'Contraseña', name: 'Nombre', chooseProblems: '¿Qué te preocupa?', chooseVoice: 'Elige la voz del psicólogo IA', male: 'Masculina', female: 'Femenina', startChat: 'Iniciar conversación', tariffs: 'Planes', tariffPrompt: 'Elige un plan para continuar', minutesLeft: 'Restante', min: 'min', hours: 'h', specialists: 'Especialistas', radio: 'SlimLight Radio', profile: 'Mi Perfil', about: 'Acerca de', contacts: 'Contactos', links: 'Enlaces', bookPsychologist: 'Reservar psicólogo', language: 'Idioma', theme: 'Tema', light: 'Claro', dark: 'Oscuro', system: 'Sistema', logout: 'Cerrar sesión', sendMessage: 'Escribe un mensaje...', freeSession: 'Consulta gratuita', paidSession: 'Sesión de pago', testFree: 'Prueba: 3 min gratis', bookConsultation: 'Reservar consulta', playing: 'Reproduciendo...', paused: 'En pausa', musicDesc: 'Música para relajarse', paymentSuccess: '¡Pago exitoso!', paymentProcessing: 'Verificando pago...', back: 'Volver', noAccount: '¿No tienes cuenta?', haveAccount: '¿Ya tienes cuenta?', anxiety: 'Ansiedad y pánico', depression: 'Depresión', relationships: 'Relaciones', ptsd: 'TEPT', self_esteem: 'Autoestima', eating_disorder: 'TCA', weight: 'Peso', grief: 'Duelo', meaning: 'Sentido de vida', other: 'Otro', expert: 'Experto del proyecto', missionTitle: 'Sobre SlimLight', missionText: 'SlimLight es una plataforma híbrida de salud mental.', ctaButton: 'Psicólogo', advance: 'Anticipo' },
  ar: { welcome: 'مرحبًا بك في SlimLight', subtitle: 'معالجك النفسي بالذكاء الاصطناعي متاح 24/7', login: 'تسجيل الدخول', register: 'إنشاء حساب', email: 'البريد الإلكتروني', password: 'كلمة المرور', name: 'الاسم', chooseProblems: 'ما الذي يقلقك؟', chooseVoice: 'اختر صوت المعالج', male: 'ذكر', female: 'أنثى', startChat: 'بدء المحادثة', tariffs: 'الباقات', tariffPrompt: 'اختر باقة للمتابعة', minutesLeft: 'المتبقي', min: 'دقيقة', hours: 'ساعة', specialists: 'المتخصصون', radio: 'SlimLight Radio', profile: 'ملفي الشخصي', about: 'حول', contacts: 'اتصل بنا', links: 'روابط', bookPsychologist: 'حجز معالج', language: 'اللغة', theme: 'المظهر', light: 'فاتح', dark: 'داكن', system: 'النظام', logout: 'تسجيل الخروج', sendMessage: 'اكتب رسالة...', freeSession: 'استشارة مجانية', paidSession: 'جلسة مدفوعة', testFree: 'تجربة: 3 دقائق مجانًا', bookConsultation: 'حجز استشارة', playing: 'قيد التشغيل...', paused: 'متوقف مؤقتًا', musicDesc: 'موسيقى للاسترخاء', paymentSuccess: 'تم الدفع بنجاح!', paymentProcessing: 'جارٍ التحقق...', back: 'رجوع', noAccount: 'ليس لديك حساب؟', haveAccount: 'لديك حساب بالفعل؟', anxiety: 'القلق والذعر', depression: 'الاكتئاب', relationships: 'العلاقات', ptsd: 'اضطراب ما بعد الصدمة', self_esteem: 'تقدير الذات', eating_disorder: 'اضطرابات الأكل', weight: 'الوزن الزائد', grief: 'الفقدان والحزن', meaning: 'البحث عن المعنى', other: 'أخرى', expert: 'خبير المشروع', missionTitle: 'حول SlimLight', missionText: 'SlimLight منصة هجينة للصحة النفسية.', ctaButton: 'معالج نفسي', advance: 'عربون' },
  fr: { welcome: 'Bienvenue sur SlimLight', subtitle: 'Votre psychologue IA disponible 24/7', login: 'Connexion', register: "S'inscrire", email: 'Email', password: 'Mot de passe', name: 'Nom', chooseProblems: 'Qu\'est-ce qui vous préoccupe ?', chooseVoice: 'Choisissez la voix du psychologue IA', male: 'Masculine', female: 'Féminine', startChat: 'Commencer la conversation', tariffs: 'Forfaits', tariffPrompt: 'Choisissez un forfait pour continuer', minutesLeft: 'Restant', min: 'min', hours: 'h', specialists: 'Spécialistes', radio: 'SlimLight Radio', profile: 'Mon Profil', about: 'À propos', contacts: 'Contacts', links: 'Liens', bookPsychologist: 'Réserver un psychologue', language: 'Langue', theme: 'Thème', light: 'Clair', dark: 'Sombre', system: 'Système', logout: 'Déconnexion', sendMessage: 'Écrivez un message...', freeSession: 'Consultation gratuite', paidSession: 'Session payante', testFree: 'Test : 3 min gratuites', bookConsultation: 'Réserver une consultation', playing: 'En cours...', paused: 'En pause', musicDesc: 'Musique relaxante', paymentSuccess: 'Paiement réussi !', paymentProcessing: 'Vérification du paiement...', back: 'Retour', noAccount: "Pas de compte ?", haveAccount: 'Déjà un compte ?', anxiety: 'Anxiété et panique', depression: 'Dépression', relationships: 'Relations', ptsd: 'TSPT', self_esteem: 'Estime de soi', eating_disorder: 'TCA', weight: 'Poids', grief: 'Deuil', meaning: 'Sens de la vie', other: 'Autre', expert: 'Expert du projet', missionTitle: 'À propos de SlimLight', missionText: 'SlimLight est une plateforme hybride de santé mentale.', ctaButton: 'Psychologue', advance: 'Acompte' },
  de: { welcome: 'Willkommen bei SlimLight', subtitle: 'Ihr KI-Psychologe, rund um die Uhr verfügbar', login: 'Anmelden', register: 'Registrieren', email: 'E-Mail', password: 'Passwort', name: 'Name', chooseProblems: 'Was beschäftigt Sie?', chooseVoice: 'Wählen Sie die Stimme des KI-Psychologen', male: 'Männlich', female: 'Weiblich', startChat: 'Gespräch beginnen', tariffs: 'Tarife', tariffPrompt: 'Wählen Sie einen Tarif, um fortzufahren', minutesLeft: 'Verbleibend', min: 'Min', hours: 'Std', specialists: 'Spezialisten', radio: 'SlimLight Radio', profile: 'Mein Profil', about: 'Über uns', contacts: 'Kontakte', links: 'Links', bookPsychologist: 'Psychologen buchen', language: 'Sprache', theme: 'Design', light: 'Hell', dark: 'Dunkel', system: 'System', logout: 'Abmelden', sendMessage: 'Nachricht schreiben...', freeSession: 'Kostenlose Beratung', paidSession: 'Bezahlte Sitzung', testFree: 'Test: 3 Min. kostenlos', bookConsultation: 'Beratung buchen', playing: 'Läuft...', paused: 'Pausiert', musicDesc: 'Entspannungsmusik', paymentSuccess: 'Zahlung erfolgreich!', paymentProcessing: 'Zahlung wird überprüft...', back: 'Zurück', noAccount: 'Kein Konto?', haveAccount: 'Bereits ein Konto?', anxiety: 'Angst & Panik', depression: 'Depression', relationships: 'Beziehungen', ptsd: 'PTBS', self_esteem: 'Selbstwertgefühl', eating_disorder: 'Essstörung', weight: 'Gewicht', grief: 'Trauer', meaning: 'Sinnsuche', other: 'Anderes', expert: 'Projektexperte', missionTitle: 'Über SlimLight', missionText: 'SlimLight ist eine hybride Plattform für psychische Gesundheit.', ctaButton: 'Psychologe', advance: 'Anzahlung' },
  hi: { welcome: 'SlimLight में आपका स्वागत है', subtitle: 'आपका AI मनोवैज्ञानिक 24/7 उपलब्ध', login: 'लॉगिन', register: 'साइन अप', email: 'ईमेल', password: 'पासवर्ड', name: 'नाम', chooseProblems: 'आपको क्या चिंता है?', chooseVoice: 'AI मनोवैज्ञानिक की आवाज़ चुनें', male: 'पुरुष', female: 'महिला', startChat: 'बातचीत शुरू करें', tariffs: 'प्लान', tariffPrompt: 'जारी रखने के लिए प्लान चुनें', minutesLeft: 'शेष', min: 'मिनट', hours: 'घंटे', specialists: 'विशेषज्ञ', radio: 'SlimLight Radio', profile: 'मेरी प्रोफ़ाइल', about: 'के बारे में', contacts: 'संपर्क', links: 'लिंक', bookPsychologist: 'मनोवैज्ञानिक बुक करें', language: 'भाषा', theme: 'थीम', light: 'लाइट', dark: 'डार्क', system: 'सिस्टम', logout: 'लॉगआउट', sendMessage: 'संदेश लिखें...', freeSession: 'निःशुल्क परामर्श', paidSession: 'भुगतान सत्र', testFree: 'परीक्षण: 3 मिनट मुफ़्त', bookConsultation: 'परामर्श बुक करें', playing: 'चल रहा है...', paused: 'रुका हुआ', musicDesc: 'आराम का संगीत', paymentSuccess: 'भुगतान सफल!', paymentProcessing: 'भुगतान जाँच रहे हैं...', back: 'वापस', noAccount: 'खाता नहीं है?', haveAccount: 'पहले से खाता है?', anxiety: 'चिंता और घबराहट', depression: 'अवसाद', relationships: 'रिश्ते', ptsd: 'PTSD', self_esteem: 'आत्म-सम्मान', eating_disorder: 'खान-पान विकार', weight: 'वज़न', grief: 'शोक', meaning: 'जीवन का अर्थ', other: 'अन्य', expert: 'प्रोजेक्ट विशेषज्ञ', missionTitle: 'SlimLight के बारे में', missionText: 'SlimLight एक हाइब्रिड मानसिक स्वास्थ्य प्लेटफ़ॉर्म है।', ctaButton: 'मनोवैज्ञानिक' },
};
